...
from other_app.models.additional_calc_models import FutureCard, PastCard, PresentCard

# Относительный путь к изображению внутри MEDIA_ROOT
IMAGE_NAME = 'placeholder.png'
IMAGE_PATH = os.path.join('past_cards', IMAGE_NAME)

# Список примеров заголовков и описаний для карт
TITLES = [
