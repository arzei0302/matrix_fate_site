...
# # class MatrixReportView(APIView):
# #     """
# #     Заполняет шаблон Word-файла данными из матрицы судьбы.
# #     """
# #     def post(self, request):
# #         matrix_values = request.data

# #         template_path = Path("/home/arzei/matrix_fate/files/matrix_fate_report.docx")
# #         # template_path = Path("/home/arzei/matrix_fate/files/matrix_fate_report2.docx")

# #         output_file = tempfile.NamedTemporaryFile(delete=False, suffix=".docx")
# #         output_path = Path(output_file.name)

# #         try:
# #             fill_matrix_template(matrix_values, template_path, output_path)
# #             return FileResponse(open(output_path, "rb"), as_attachment=True, filename="matrix_result.docx")
# #         except Exception as e:
